...
BoardAS.prototype.twin = function () {
...
BoardAS.prototype.tiles_swapped = function () {
  return this._tiles_swapped;
}

BoardAS.prototype.swap = function (blks, x1, y1, x2, y2) {
  var temp = blks[x1][y1];
  blks[x1][y1] = blks[x2][y2];
  blks[x2][y2] = temp;
  return blks;
};
BoardAS.prototype.createNewBlocks = function (newPosition) {
  function copy(arr) {
...
BoardAS.prototype.isGoal = function () {
...
BoardAS.prototype.equals = function (other) {
