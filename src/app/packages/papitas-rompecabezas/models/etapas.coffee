...
Inicio del ciclo agrícola.
    """
    descripcion: """
En el inicio del ciclo agrícola, el campesino muestra 
...
entierra o se quema cerca a la *chacra*. 
    """

    pregunta: 
      texto: """
¿Con la ofrenda a la *Pachamama* y a los
*apus* se inicia el ciclo agrícola de la papa?
      """
      respuesta:
        correcta: 'si'
        si: """
...
La ofrenda es un ritual para empezar el ciclo agrícola.
        """
...
Siembra
    """
    descripcion: """
La siembra es la actividad más importante en el ciclo 
...
abonar la tierra. 
    ...
    pregunta: 
      texto: """
¿El campesino observa las señas de la naturaleza para sembrar? 
      """
      respuesta:
        correcta: 'si'
        si: """
...
Los campesinos se guían por señales de la naturaleza para iniciar la siembra.
        """
    numero: 2
  }
  {
...
El aporque.
    """
    descripcion: """
El aporque es una actividad que realizan los varones 
...
- Se alimenta con más tierra el tallo de la planta de papa. 
    ...
    pregunta: 
      texto: """
¿Las plantas de papa sin aporque crecen sanas? 
      """
      respuesta:
        correcta: 'no'
        si: """
...
El aporque ayuda al sano crecimiento de las plantas de papa. 
        """
        no: """
¡Correcto!
        """
  ...
  }
  {
    nombre: "Aporque"
    titulo: """
Criando la papa en la chacra desde 
la siembra hasta la cosecha.
    """
    descripcion: """
El cuidado de las papas en su ciclo de producción es 
...
el agua no inunde los surcos. 
    """
    
    pregunta: 
      texto: """
¿Para los agricultores del Ande, cultivar papas es como criar a un hijo? 
      """
      respuesta:
        correcta: 'si'
        si: """
...
como la crianza de un hijo. 
  ...
  }
  {
    nombre: "Roturado"
    titulo: """
**Febrero y Marzo**: Preparación
de la tierra para la nueva siembra.
    """
    descripcion: """
Mientras las plantas de papa están creciendo en la 
...
lista para acoger a las semillas de papa. 
    """
    
    pregunta: 
      texto: """
¿El roturado prepara el terreno para la cosecha? 
      """
      respuesta:
        correcta: 'no'
        si: """
...
El roturado prepara el terreno para la nueva siembra. 
        """
        no: """
¡Correcto!
        """
...
Cosecha
    """
    descripcion: """
La cosecha consiste en extraer de la tierra y 
...
alejan. 
    ...
    pregunta: 
      texto: """
¿La naturaleza puede darnos señales para empezar la cosecha de papas? 
      """
      respuesta:
        correcta: 'si'
        si: """
...
el clima para que empiecen la cosecha. 
        """
...
El día de la cosecha.
    """
    descripcion: """
Durante la cosecha se pueden ver muchas 
...
caballos o llamas hasta el lugar de almacenamiento.
    ...
    pregunta: 
      texto: """
¿El día de la cosecha se lleva papa a la chacra en caballos para 
preparar la watia? 
      """
      respuesta:
        correcta: 'no'
...
Se prepara la watia con la papa recién cosechada en la chacra.
        """
        no: """
¡Correcto!
        """
...
Selección de papas.
    """
    descripcion: """
Es una actividad que se realiza en familia, los padres 
...
presentar enfermedades.
    ...
    pregunta: 
      texto: """
¿La semilla de papa con ojos bonitos es una característica 
apreciada por los agricultores del Ande? 
      """
      respuesta:
        correcta: 'si'
        si: """
...
Lo que sobra se vende. 
    """
    
    pregunta: 
      texto: """
¿La semilla de papa se guarda en el almacén 
familiar? 
      """
      respuesta:
        correcta: 'no'
...
La semilla de papa se guarda a la intemperie cerca a la casa. 
        """
        no: """
¡Correcto!
        """
...
hasta la llegada de la papa nueva. 
    """
    
    pregunta: 
      texto: """
¿Las papas viejas y arrugadas se desechan? 
      """
      respuesta:
        correcta: 'no'
        si: """
...
Las papas viejas continúan alimentando a las familias porque son muy dulces. 
        """
        no: """
¡Correcto!
        """
