...
Lists = new GroundDB(new Meteor.Collection("lists", { connection: null }));
Todos = new GroundDB(new Meteor.Collection("todos", { connection: null }));
...
Template.lists.loading = function () {
  return false; //!listsHandle.ready();
};
...
Template.todos.loading = function () {
  return false //todosHandle; // && !todosHandle.ready();
};
